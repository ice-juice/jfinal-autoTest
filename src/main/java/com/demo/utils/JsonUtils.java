...
//			String val = jsonObject.getString(string);
//			map.put(string, val);
//		}
//		return map;
//	}
	...
	*            代表从实体类型
	...
	/**
	 * json字符串转为map，对null值特殊处理
	 * */
	public static Map<String,String> getResultMap(String res) {
		Map<String,Object> jsonMap = JsonUtils.parseJSON2Map(res);
	...
	//递归遍历解析方法
	public static boolean iteraJsonToMap(String str,Map res){
		...
		while(keys.hasNext()){
			...
			if(!iteraJsonToMap(value.toString(),res)){
				res.put(key, value);
			}
		}
		return true;
